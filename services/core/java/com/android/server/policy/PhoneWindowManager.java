    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.AICP_USE_BOTTOM_GESTURE_NAVIGATION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    private void interceptPowerKeyDown(KeyEvent event, boolean interactive) {
        ...
        if (!mPowerKeyHandled) {
            if (interactive) {
                ...
                if (mTorchLongPressPowerEnabled || mSupportLongPressPowerWhenNonInteractive && hasLongPressOnPowerBehavior()) {
                    mResolvedLongPressOnPowerBehavior = getResolvedLongPressOnPowerBehavior();
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mUseGestureButton = Settings.System.getIntForUser(resolver,
                    Settings.System.AICP_USE_BOTTOM_GESTURE_NAVIGATION, 0,
                    UserHandle.USER_CURRENT) != 0;
    ...
    private void takeScreenrecord(final int mode) {
        synchronized (mScreenrecordLock) {
            ...
            ComponentName cn = new ComponentName("com.android.systemui",
                    "com.android.systemui.aicp.screenrecord.TakeScreenrecordService");
